...
user_eir_long$fill <- ifelse(user_eir_long$run %in% 
                               c("One user",
                                 ...
                                 "50% usage  ",
                                 "80% usage  "), "Direct", 
                             ifelse(user_eir_long$run %in% c("One user    ",
                                                             "10% usage    ",
                                                             "50% usage    ",
                                                             "80% usage    "),
                                    "Total", "Indirect"))
...
a <- eir_data_long %>% filter(cat == "Net user",
                              resistance == "0%", 
                              run == "50% usage  ")
print(sprintf("eir direct insect 50%% user 0 resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Net user",
                              resistance == "80%", 
                              run == "50% usage  ")
print(sprintf("eir direct insect 50%% user 80%% resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Net user",
                              resistance == "0%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% user 0 resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Non net user",
                              resistance == "0%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% non user 0 resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Community",
                              resistance == "0%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% community 0 resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Community",
                              resistance == "0%", 
                              run == "50% usage    ")
print(sprintf("total eir 50%% community 0 resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))
saveRDS(a, "outputs/community_total_no_res.RDS")

a <- eir_data_long %>% filter(cat == "Net user",
                              resistance == "80%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% user 80%% resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Non net user",
                              resistance == "80%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% non user 80%% resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Community",
                              resistance == "80%", 
                              run == "50% usage   ")
print(sprintf("eir indirect insect 50%% community 80%% resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))

a <- eir_data_long %>% filter(cat == "Community",
                              resistance == "80%", 
                              run == "50% usage    ")
print(sprintf("total eir 50%% community 80%% resistance:%.0f [95%% CI: %.0f - %.0f]", round(quantile(a$eir, probs= 0.5),0), 
              round.choose(quantile(a$eir, probs= 0.025), 1, 0), round.choose(quantile(a$eir, probs=0.975), 1, 1)))
saveRDS(a, "outputs/community_total_res.RDS")
...
print(p)
ggsave("figures/fig_4.pdf", p, height = 7, width = 12)
ggsave("figures/fig_4.png", p, height = 7, width = 12)
